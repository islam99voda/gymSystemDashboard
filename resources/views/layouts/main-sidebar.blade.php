        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                    ...
                    </svg><span class="side-menu__label">players</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    {{-- <li><a class="slide-item" href="{{ url('/players/create') . ($page = 'chart-morris') }}">Add Player</a></li> --}}
                    <li><a class="slide-item" href="{{ url('/players/create') }}">Add
                            Player</a></li>
                    <li><a class="slide-item" href="{{ url('/players') }}">view Players</a></li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        <path
                            d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z" />
                    </svg><span class="side-menu__label">Coaches</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    {{-- <li><a class="slide-item" href="{{ url('/players/create') . ($page = 'chart-morris') }}">Add Player</a></li> --}}
                    <li><a class="slide-item" href="{{ url('/coaches/create') }}">Add
                            Coach</a></li>
                    <li><a class="slide-item" href="{{ url('/coaches') }}">view Coaches</a></li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        <path
                            d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z" />
                    </svg><span class="side-menu__label">Winners</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    {{-- <li><a class="slide-item" href="{{ url('/players/create') . ($page = 'chart-morris') }}">Add Player</a></li> --}}
                    <li><a class="slide-item" href="{{ url('/winners/create') }}">Add
                            Winner</a></li>
                    <li><a class="slide-item" href="{{ url('/winners') }}">view Winners</a></li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        <path
                            d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z" />
                    </svg><span class="side-menu__label">Champions</span><i class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    {{-- <li><a class="slide-item" href="{{ url('/players/create') . ($page = 'chart-morris') }}">Add Player</a></li> --}}
                    <li><a class="slide-item" href="{{ url('/champions/create') }}">Add
                            Champion</a></li>
                    <li><a class="slide-item" href="{{ url('/champions') }}">view Champions</a></li>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                        ...
                        <path
                            d="M3 5v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2H5c-1.1 0-2 .9-2 2zm2 0h14v14H5V5zm2 5h2v7H7zm4-3h2v10h-2zm4 6h2v4h-2z" />
                    </svg><span class="side-menu__label">Subscriptions</span><i
                        class="angle fe fe-chevron-down"></i></a>
                <ul class="slide-menu">
                    {{-- <li><a class="slide-item" href="{{ url('/players/create') . ($page = 'chart-morris') }}">Add Player</a></li> --}}
                    <li><a class="slide-item" href="{{ url('/subscriptions/create') }}">Add
                            subscription</a></li>
                    <li><a class="slide-item" href="{{ url('/subscriptions') }}">view subscription</a></li>
